...
Do not paste these files into chat. Open the one you need:

| File | When to read |
|------|----------------|
| [ddd/bounded-contexts.md](ddd/bounded-contexts.md) | Aggregates, invariants, Kafka names |
| [ddd/context-map.md](ddd/context-map.md) | Upstream/downstream + ACLs |
